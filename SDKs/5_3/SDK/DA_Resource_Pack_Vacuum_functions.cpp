...
{
	static auto Func = Class->GetFunction("DA_Resource_Pack_Vacuum_C", "IsOnGround");
...
{
	static auto Func = Class->GetFunction("DA_Resource_Pack_Vacuum_C", "RaiseUsageError");
...
{
	static auto Func = Class->GetFunction("DA_Resource_Pack_Vacuum_C", "UserConstructionScript");

	Params::ADA_Resource_Pack_Vacuum_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("DA_Resource_Pack_Vacuum_C", "BPPressTrigger");
...
{
	static auto Func = Class->GetFunction("DA_Resource_Pack_Vacuum_C", "BPReleaseTrigger");
...
{
	static auto Func = Class->GetFunction("DA_Resource_Pack_Vacuum_C", "ExecuteUbergraph_DA_Resource_Pack_Vacuum");

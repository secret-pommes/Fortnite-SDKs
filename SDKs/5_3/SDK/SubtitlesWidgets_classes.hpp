...
{
public:
	uint8                                        Pad_FAA[0x18];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_FAB[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_FAC[0x214];                                    // Fixing Size Of Struct [ Dumper-7 ]

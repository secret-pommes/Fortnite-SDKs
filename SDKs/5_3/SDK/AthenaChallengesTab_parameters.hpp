...
public:
	...
	uint8                                        Pad_3AC9[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
struct UAthenaChallengesTab_C_OnCursorModeChanged_Params
{
public:
...
struct UAthenaChallengesTab_C_Destruct_Params
{
public:
};
...
public:
	...
	class UFortChallengeBundleInfo*              K2Node_DynamicCast_AsFort_Challenge_Bundle_Info;   // 0x38(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UAthenaChallengeTreeEntry_C*           K2Node_DynamicCast_AsAthena_Challenge_Tree_Entry;  // 0x60(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	UInterfaceProperty_                          CallFunc_SetTimespanSource_Value_CastInput;        // 0x70(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor)
	UDelegateProperty_                           K2Node_CreateDelegate_OutputDelegate1;             // 0x80(0x10)(ZeroConstructor, NoDestructor)
	class UAthenaAccountContext*                 CallFunc_GetContext_ReturnValue;                   // 0x90(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                        CallFunc_GetCurrentSeasonNumber_ReturnValue;       // 0x98(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UFortHUDContext*                       CallFunc_GetContext_ReturnValue2;                  // 0xA8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                         K2Node_Event_IsDesignTime;                         // 0xBA(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};

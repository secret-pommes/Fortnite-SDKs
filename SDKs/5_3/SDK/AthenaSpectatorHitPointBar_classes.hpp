...
public:
	...
	void ExecuteUbergraph_AthenaSpectatorHitPointBar(int32 EntryPoint, bool K2Node_SwitchEnum_CmpSuccess, float CallFunc_SelectFloat_ReturnValue, bool K2Node_Event_IsDesignTime);
};

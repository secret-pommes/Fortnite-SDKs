...
{
	static auto Func = Class->GetFunction("GCNL_Cube_Area_C", "UserConstructionScript");

	Params::AGCNL_Cube_Area_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("GCNL_Cube_Area_C", "OnLoopingStart");
...
{
	static auto Func = Class->GetFunction("GCNL_Cube_Area_C", "OnRemoval");
...
{
	static auto Func = Class->GetFunction("GCNL_Cube_Area_C", "On Shield Squares Spawn");
...
{
	static auto Func = Class->GetFunction("GCNL_Cube_Area_C", "ExecuteUbergraph_GCNL_Cube_Area");

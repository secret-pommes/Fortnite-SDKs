...
public:
	...
	void PlaySoundFromType(enum class EAthenaGameMsgType Type, enum class EAthenaGameMsgType Temp_byte_Variable, class USoundBase* Temp_object_Variable, class USoundBase* Temp_object_Variable1, class USoundBase* Temp_object_Variable2, class USoundBase* Temp_object_Variable3, class USoundBase* K2Node_Select_Default, bool CallFunc_IsValid_ReturnValue);
	void CustomEvent();

...
public:
	...
	uint8                                        Pad_3FF3[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3FF4[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class AFort_Entry_Music_Controller_BP_C*     MusicController;                                   // 0x500(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

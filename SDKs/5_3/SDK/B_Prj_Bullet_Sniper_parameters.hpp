...
public:
	...
	uint8                                        Pad_5F61[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FVector                               CallFunc_Multiply_VectorFloat_ReturnValue;         // 0x12C(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FRotator                              CallFunc_Conv_VectorToRotator_ReturnValue;         // 0x138(0xC)(IsPlainOldData, NoDestructor)

...
{
	static auto Func = Class->GetFunction("B_Assault_Surgical_Thermal_Athena_C", "UserConstructionScript");

	Params::AB_Assault_Surgical_Thermal_Athena_C_UserConstructionScript_Params Parms;

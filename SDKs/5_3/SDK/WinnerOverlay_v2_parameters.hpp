...
public:
	...
	class FString                                CallFunc_GetCurrentLanguage_ReturnValue;           // 0x28(0x10)(ZeroConstructor, HasGetValueTypeHash)
	bool                                         CallFunc_Contains_ReturnValue;                     // 0x38(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_Contains_ReturnValue1;                    // 0x39(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_BooleanOR_ReturnValue;                    // 0x3A(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_BooleanOR_ReturnValue1;                   // 0x3B(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	struct FMargin                               K2Node_MakeStruct_Margin;                          // 0x44(0x10)(IsPlainOldData, NoDestructor)
};

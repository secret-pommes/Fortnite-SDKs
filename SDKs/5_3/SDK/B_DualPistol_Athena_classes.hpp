...
public:
	...
	struct FPointerToUberGraphFrame              UberGraphFrame;                                    // 0xF60(0x8)(Transient, DuplicateTransient)
	class USoundCue*                             FireSoundOverride;                                 // 0xF68(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

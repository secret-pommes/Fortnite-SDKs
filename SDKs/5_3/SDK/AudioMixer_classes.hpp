...
public:
	...
	uint8                                        Pad_41[0x20];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_42[0x30];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_48[0x50];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_49[0x38];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_4B[0x58];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_4C[0x20];                                      // Fixing Size Of Struct [ Dumper-7 ]

...
public:
	...
	class UParticleSystemComponent*              RearMuzzle;                                        // 0xF48(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)

...
public:
	...
	uint8                                        Pad_5F1B[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FHitResult                            K2Node_Event_Hit2;                                 // 0xD8(0x88)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	struct FHitResult                            K2Node_Event_Hit1;                                 // 0x160(0x88)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
};

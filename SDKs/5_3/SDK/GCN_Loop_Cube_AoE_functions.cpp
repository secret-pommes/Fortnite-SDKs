...
{
	static auto Func = Class->GetFunction("GCN_Loop_Cube_AoE_C", "UserConstructionScript");

	Params::AGCN_Loop_Cube_AoE_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("GCN_Loop_Cube_AoE_C", "OnLoopingStart");
...
{
	static auto Func = Class->GetFunction("GCN_Loop_Cube_AoE_C", "ReceiveTick");
...
{
	static auto Func = Class->GetFunction("GCN_Loop_Cube_AoE_C", "OnRemoval");
...
{
	static auto Func = Class->GetFunction("GCN_Loop_Cube_AoE_C", "TargetPlayerLanded");
...
{
	static auto Func = Class->GetFunction("GCN_Loop_Cube_AoE_C", "ExecuteUbergraph_GCN_Loop_Cube_AoE");

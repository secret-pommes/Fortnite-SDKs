...
struct ATrap_Athena_WallSpikes_C_UserConstructionScript_Params
{
public:
};
...
struct ATrap_Athena_WallSpikes_C_SetSpikePosition_Params
{
public:
...
struct ATrap_Athena_WallSpikes_C_ExecuteUbergraph_Trap_Athena_WallSpikes_Params
{
public:
	int32                                        EntryPoint;                                        // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        K2Node_Event_NewSpikePosition;                     // 0x4(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

...
public:
	...
	uint8                                        Pad_11FE[0xE];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_11FF[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1201[0x58];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1202[0xA8];                                    // Fixing Size Of Struct [ Dumper-7 ]

...
public:
	...
	uint8                                        Pad_255E[0x24];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        BitPad_221 : 7;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	uint8                                        BitPad_224 : 7;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	uint8                                        Pad_2569[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_256B[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_256C[0x2];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_256D[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_256F[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2570[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2571[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2572[0x1F];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2573[0xA0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<struct FProceduralFoliageInstance>    InstancesArray;                                    // 0xD0(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                        Pad_2574[0x78];                                    // Fixing Size Of Struct [ Dumper-7 ]

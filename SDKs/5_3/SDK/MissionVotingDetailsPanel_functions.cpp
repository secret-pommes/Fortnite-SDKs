...
// enum class EFortVoteType           Temp_byte_Variable8                                              (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UMissionVotingDetailsPanel_C::UpdateDisplay(bool IsSinglePlayer, enum class EFortVoteType Temp_byte_Variable, class FText Temp_text_Variable, class FText Temp_text_Variable1, class FText Temp_text_Variable2, bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable1, bool Temp_bool_Variable1, class FText Temp_text_Variable3, class FText Temp_text_Variable4, bool Temp_bool_Variable2, class FText Temp_text_Variable5, class FText Temp_text_Variable6, bool Temp_bool_Variable3, class FText Temp_text_Variable7, class FText Temp_text_Variable8, enum class EFortVoteType Temp_byte_Variable2, class UMaterialInterface* Temp_object_Variable, class UMaterialInterface* Temp_object_Variable1, class UMaterialInterface* Temp_object_Variable2, enum class EFortVoteType Temp_byte_Variable3, class FText Temp_text_Variable9, class FText Temp_text_Variable10, class FText Temp_text_Variable11, enum class EFortVoteType Temp_byte_Variable4, enum class ESlateVisibility Temp_byte_Variable5, enum class ESlateVisibility Temp_byte_Variable6, enum class ESlateVisibility Temp_byte_Variable7, enum class EFortVoteType Temp_byte_Variable8, bool CallFunc_IsVoteRequired_VoteRequired, class FText K2Node_Select_Default, class FText K2Node_Select1_Default, class FText K2Node_Select2_Default, class FText Temp_text_Variable12, class FText Temp_text_Variable13, bool Temp_bool_Variable4, class FText K2Node_Select3_Default, class FText K2Node_Select4_Default, bool CallFunc_IsVoteRequired_VoteRequired1, class UMaterialInterface* K2Node_Select5_Default, int32 CallFunc_GetStartObjectiveBluGloRequirement_ReturnValue, bool K2Node_SwitchEnum_CmpSuccess, class FText CallFunc_Conv_IntToText_ReturnValue, int32 CallFunc_GetIncreaseDifficultyBluGloRequirement_ReturnValue, class FText CallFunc_Conv_IntToText_ReturnValue1, class FText K2Node_Select6_Default, enum class ESlateVisibility K2Node_Select7_Default, enum class ESlateVisibility K2Node_Select8_Default, class FText K2Node_Select9_Default)
{

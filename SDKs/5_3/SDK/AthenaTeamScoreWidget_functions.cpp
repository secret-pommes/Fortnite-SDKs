...
{
	static auto Func = Class->GetFunction("AthenaTeamScoreWidget_C", "UpdateLeaderboard");
...
{
	static auto Func = Class->GetFunction("AthenaTeamScoreWidget_C", "OnLeaderboardChanged");

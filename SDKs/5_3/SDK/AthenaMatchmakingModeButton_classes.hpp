...
public:
	...
	void SetSquadFillText(bool InFillText, bool InHideFill, bool Temp_bool_Variable, class FText Temp_text_Variable, class FText Temp_text_Variable1, class FText K2Node_Select_Default);

...
{
	static auto Func = Class->GetFunction("B_Pistol_AutoHeavy_Athena_C", "UserConstructionScript");

	Params::AB_Pistol_AutoHeavy_Athena_C_UserConstructionScript_Params Parms;

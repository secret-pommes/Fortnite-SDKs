...
{
	static auto Func = Class->GetFunction("BP_ProjectileTrajectory_Athena_SnapToGridArrow_C", "HandleGridSnapUpdates");
...
{
	static auto Func = Class->GetFunction("BP_ProjectileTrajectory_Athena_SnapToGridArrow_C", "UserConstructionScript");

	Params::ABP_ProjectileTrajectory_Athena_SnapToGridArrow_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_ProjectileTrajectory_Athena_SnapToGridArrow_C", "ReceiveBeginPlay");

	Params::ABP_ProjectileTrajectory_Athena_SnapToGridArrow_C_ReceiveBeginPlay_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_ProjectileTrajectory_Athena_SnapToGridArrow_C", "SetTrajectorySpline");
...
{
	static auto Func = Class->GetFunction("BP_ProjectileTrajectory_Athena_SnapToGridArrow_C", "ExecuteUbergraph_BP_ProjectileTrajectory_Athena_SnapToGridArrow");

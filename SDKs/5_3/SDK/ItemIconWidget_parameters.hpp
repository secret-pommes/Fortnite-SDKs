...
public:
	...
	class UTexture2D*                            CallFunc_GetOrLoadSynchronously_ReturnValue;       // 0x48(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FSlateBrush                           CallFunc_MakeBrushFromTexture_ReturnValue;         // 0x58(0x88)()
};

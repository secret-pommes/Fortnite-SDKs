...
struct UAthenaMinimapContainer_C_BndEvt__MapButton_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature_Params
{
public:
};
...
struct UAthenaMinimapContainer_C_ExecuteUbergraph_AthenaMinimapContainer_Params
{
public:

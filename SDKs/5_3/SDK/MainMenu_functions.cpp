...
// class APlayerController*           CallFunc_GetOwningPlayer_ReturnValue                             (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UAthenaChallengesTab_C*      CallFunc_Create_ReturnValue                                      (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class APlayerController*           CallFunc_GetOwningPlayer_ReturnValue1                            (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_IsMobileGame_ReturnValue                                (ZeroConstructor, IsPlainOldData, NoDestructor)
// class UTeamSelectWidget_C*         CallFunc_Create_ReturnValue1                                     (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UPrivacyWidget_C*            CallFunc_Create_ReturnValue2                                     (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// int32                              CallFunc_Array_Length_ReturnValue                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UFortGlobalUIContext*        CallFunc_GetContext_ReturnValue2                                 (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// int32                              Temp_int_Loop_Counter_Variable                                   (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UShowFriendCodesSelection_C* CallFunc_Create_ReturnValue3                                     (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UMessageCenterWidget_C*      CallFunc_Create_ReturnValue4                                     (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UNews_C*                     CallFunc_Create_ReturnValue5                                     (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UPermissionsRoot_C*          CallFunc_Create_ReturnValue6                                     (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class ULegalInfo_C*                CallFunc_Create_ReturnValue7                                     (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UOptionsMenu_C*              CallFunc_Create_ReturnValue8                                     (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UMainMenu_C::InitializeMainMenu(bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable1, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue, bool CallFunc_IsInZone_ReturnValue, enum class ESlateVisibility K2Node_Select_Default, int32 Temp_int_Array_Index_Variable, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue1, bool CallFunc_AllowLogout_ReturnValue, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UAthenaChallengesTab_C* CallFunc_Create_ReturnValue, enum class ESlateVisibility Temp_byte_Variable2, bool CallFunc_IsInAthena_ReturnValue, enum class ESlateVisibility Temp_byte_Variable3, bool Temp_bool_Variable1, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue1, bool CallFunc_IsMobileGame_ReturnValue, class UTeamSelectWidget_C* CallFunc_Create_ReturnValue1, bool CallFunc_IsErebus_ReturnValue, bool Temp_bool_Variable2, enum class ESlateVisibility K2Node_Select1_Default, TArray<class UIconTextButton_C*>& K2Node_MakeArray_Array, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue2, class UIconTextButton_C* CallFunc_Array_Get_Item, class UPrivacyWidget_C* CallFunc_Create_ReturnValue2, int32 CallFunc_Array_Length_ReturnValue, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue2, int32 Temp_int_Loop_Counter_Variable, bool CallFunc_IsInZone_ReturnValue1, bool CallFunc_BooleanOR_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue, bool CallFunc_BooleanOR_ReturnValue1, int32 CallFunc_Add_IntInt_ReturnValue, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue3, class UFortUIDataConfigurationContext* CallFunc_GetContext_ReturnValue3, class UShowFriendCodesSelection_C* CallFunc_Create_ReturnValue3, bool CallFunc_ArePartyFeaturesEnabled_ReturnValue, bool CallFunc_IsOutpostOwner_OutpostOwner, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue4, bool CallFunc_AllowQuit_ReturnValue, bool CallFunc_IsInZone_ReturnValue2, enum class ESlateVisibility Temp_byte_Variable4, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, enum class ESlateVisibility Temp_byte_Variable5, bool Temp_bool_Variable3, enum class ESlateVisibility K2Node_Select2_Default, enum class ESlateVisibility Temp_byte_Variable6, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue5, enum class ESlateVisibility Temp_byte_Variable7, bool CallFunc_IsInZone_ReturnValue3, bool CallFunc_BooleanAND_ReturnValue1, enum class ESlateVisibility K2Node_Select3_Default, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue4, class UMessageCenterWidget_C* CallFunc_Create_ReturnValue4, class UNews_C* CallFunc_Create_ReturnValue5, class UPermissionsRoot_C* CallFunc_Create_ReturnValue6, class ULegalInfo_C* CallFunc_Create_ReturnValue7, class UOptionsMenu_C* CallFunc_Create_ReturnValue8)
{
...
{
	static auto Func = Class->GetFunction("MainMenu_C", "Tick");

	Params::UMainMenu_C_Tick_Params Parms;
...
// bool                               Temp_bool_Variable1                                              (ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                               CallFunc_IsMatchmakingFlowActive_ReturnValue                     (ZeroConstructor, IsPlainOldData, NoDestructor)
// enum class ESlateVisibility        Temp_byte_Variable7                                              (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_Not_PreBool_ReturnValue                                 (ZeroConstructor, IsPlainOldData, NoDestructor)
...
// class UCommonInputContext*         CallFunc_GetContext_ReturnValue11                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// bool                               CallFunc_IsInZone_ReturnValue1                                   (ZeroConstructor, IsPlainOldData, NoDestructor)
// class UFortHUDContext*             CallFunc_GetContext_ReturnValue17                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UFortFrontEndContext*        CallFunc_GetContext_ReturnValue19                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// UDelegateProperty_                 K2Node_CreateDelegate_OutputDelegate3                            (ZeroConstructor, NoDestructor)
...
// class UCommonUIContext*            CallFunc_GetContext_ReturnValue21                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UCommonInputManager*         CallFunc_GetInputManager_ReturnValue4                            (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UFortHUDContext*             CallFunc_GetContext_ReturnValue23                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UFortFrontEndContext*        CallFunc_GetContext_ReturnValue24                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UFortFrontEndContext*        CallFunc_GetContext_ReturnValue25                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UFortFrontEndContext*        CallFunc_GetContext_ReturnValue26                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UFortGlobalUIContext*        CallFunc_GetContext_ReturnValue27                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UMainMenu_C::ExecuteUbergraph_MainMenu(int32 EntryPoint, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate1, enum class EFortDialogResult K2Node_CustomEvent_Result, class FName K2Node_CustomEvent_ResultName, class FName Temp_name_Variable, enum class EFortDialogResult Temp_byte_Variable, bool K2Node_SwitchEnum_CmpSuccess, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue, enum class ESubGame Temp_byte_Variable1, enum class ESlateVisibility Temp_byte_Variable2, enum class ESlateVisibility Temp_byte_Variable3, enum class ESlateVisibility Temp_byte_Variable4, class UHUDLayoutToolContext* CallFunc_GetContext_ReturnValue1, bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable5, enum class ESlateVisibility Temp_byte_Variable6, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue2, class UFortHUDContext* CallFunc_GetContext_ReturnValue3, bool CallFunc_IsInZone_ReturnValue, class UCommonUIContext* CallFunc_GetContext_ReturnValue4, class UFortHUDContext* CallFunc_GetContext_ReturnValue5, class UCommonInputManager* CallFunc_GetInputManager_ReturnValue, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue6, class UCommonUIContext* CallFunc_GetContext_ReturnValue7, class UFortHUDContext* CallFunc_GetContext_ReturnValue8, class UCommonInputManager* CallFunc_GetInputManager_ReturnValue1, class UFortMatchmakingContext* CallFunc_GetContext_ReturnValue9, bool Temp_bool_Variable1, bool CallFunc_IsMatchmakingFlowActive_ReturnValue, enum class ESlateVisibility Temp_byte_Variable7, bool CallFunc_Not_PreBool_ReturnValue, enum class ESlateVisibility Temp_byte_Variable8, class UCommonButton* K2Node_ComponentBoundEvent_Button62, class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button61, class UCommonButton* K2Node_ComponentBoundEvent_Button60, class UCommonButton* K2Node_ComponentBoundEvent_Button59, class UCommonButton* K2Node_ComponentBoundEvent_Button58, class UCommonButton* K2Node_ComponentBoundEvent_Button57, class FText CallFunc_GetEmptyText_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button56, class UCommonButton* K2Node_ComponentBoundEvent_Button55, class UCommonButton* K2Node_ComponentBoundEvent_Button54, class UCommonButton* K2Node_ComponentBoundEvent_Button53, class UCommonButton* K2Node_ComponentBoundEvent_Button52, class UCommonButton* K2Node_ComponentBoundEvent_Button51, class UCommonButton* K2Node_ComponentBoundEvent_Button50, class UCommonButton* K2Node_ComponentBoundEvent_Button49, class UCommonButton* K2Node_CustomEvent_Button3, class UIconTextButton_C* CallFunc_GetButton_Leave, class UCommonButton* K2Node_CustomEvent_Button2, class UIconTextButton_C* CallFunc_GetButton_Leave1, class UCommonButton* K2Node_ComponentBoundEvent_Button48, class FText CallFunc_GetLeaveActionText_Text, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate2, class UCommonButton* K2Node_ComponentBoundEvent_Button47, class UCommonButton* K2Node_ComponentBoundEvent_Button46, class UCommonButton* K2Node_ComponentBoundEvent_Button45, class UCommonButton* K2Node_ComponentBoundEvent_Button44, class UFortPartyContext* CallFunc_GetContext_ReturnValue10, class UCommonInputContext* CallFunc_GetContext_ReturnValue11, enum class ECommonInputType CallFunc_GetCurrentInputType_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue, int32 CallFunc_GetNumPlayersInLocalParty_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button43, bool CallFunc_Greater_IntInt_ReturnValue, class UFortPartyContext* CallFunc_GetContext_ReturnValue12, bool CallFunc_ShouldShowCrossplayWarningDialog_ReturnValue, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue13, enum class ESubGame CallFunc_GetSubGame_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button42, class UCommonButton* K2Node_ComponentBoundEvent_Button41, class UCommonButton* K2Node_ComponentBoundEvent_Button40, class UCommonButton* K2Node_ComponentBoundEvent_Button39, class UCommonButton* K2Node_ComponentBoundEvent_Button38, class UCommonButton* K2Node_ComponentBoundEvent_Button37, class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue1, class UCommonButton* K2Node_ComponentBoundEvent_Button36, class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue2, class UCommonButton* K2Node_ComponentBoundEvent_Button35, class UClass* Temp_class_Variable, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UClass* K2Node_ClassDynamicCast_AsUser_Widget, bool K2Node_ClassDynamicCast_bSuccess, class UBoostsRoot_C* CallFunc_Create_ReturnValue, class UClass* K2Node_CustomEvent_Loaded, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue14, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue15, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue16, bool CallFunc_IsInZone_ReturnValue1, class UFortHUDContext* CallFunc_GetContext_ReturnValue17, class UCommonUIContext* CallFunc_GetContext_ReturnValue18, class UCommonInputManager* CallFunc_GetInputManager_ReturnValue2, class UCommonButton* K2Node_ComponentBoundEvent_Button34, class UCommonButton* K2Node_ComponentBoundEvent_Button33, class UCommonButton* K2Node_ComponentBoundEvent_Button32, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue19, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate3, class UClass* CallFunc_GetUITestingClass_ReturnValue, bool CallFunc_IsValidClass_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button31, class UCommonButton* K2Node_ComponentBoundEvent_Button30, class UCommonButton* K2Node_ComponentBoundEvent_Button29, class UCommonButton* K2Node_ComponentBoundEvent_Button28, class UCommonButton* K2Node_ComponentBoundEvent_Button27, class UCommonButton* K2Node_ComponentBoundEvent_Button26, class UCommonButton* K2Node_ComponentBoundEvent_Button25, class UCommonButton* K2Node_ComponentBoundEvent_Button24, class UCommonButton* K2Node_ComponentBoundEvent_Button23, class FText CallFunc_GetEmptyText_ReturnValue1, class UCommonUIContext* CallFunc_GetContext_ReturnValue20, class UCommonInputManager* CallFunc_GetInputManager_ReturnValue3, class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue3, class UUserWidget* CallFunc_GetCachedWidget_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button22, class UCommonButton* K2Node_ComponentBoundEvent_Button21, class UCommonButton* K2Node_ComponentBoundEvent_Button20, class UCommonButton* K2Node_CustomEvent_Button1, class UCommonButton* K2Node_CustomEvent_Button, class UFortUINavigationManager* CallFunc_GetUINavigationManager_ReturnValue, bool K2Node_ComponentBoundEvent_Visibility1, class UCommonButton* K2Node_ComponentBoundEvent_Button19, class UCommonButton* K2Node_ComponentBoundEvent_Button18, class UCommonButton* K2Node_ComponentBoundEvent_Button17, class UCommonButton* K2Node_ComponentBoundEvent_Button16, class UCommonUIContext* CallFunc_GetContext_ReturnValue21, class UCommonButton* K2Node_ComponentBoundEvent_Button15, class UCommonInputManager* CallFunc_GetInputManager_ReturnValue4, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue22, bool CallFunc_IsInZone_ReturnValue2, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue1, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate4, class UUserWidget* CallFunc_Create_ReturnValue1, bool K2Node_ComponentBoundEvent_Visibility, class UFortHUDContext* CallFunc_GetContext_ReturnValue23, class UCommonButton* K2Node_ComponentBoundEvent_Button14, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue24, class UCommonButton* K2Node_ComponentBoundEvent_Button13, class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue4, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue25, class UUserWidget* CallFunc_GetCachedWidget_ReturnValue1, class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue5, class UBacchusControlsHelp_C* K2Node_DynamicCast_AsBacchus_Controls_Help, bool K2Node_DynamicCast_bSuccess, bool CallFunc_IsValid_ReturnValue, enum class ESlateVisibility CallFunc_GetVisibility_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button12, enum class ESlateVisibility K2Node_Select_Default, class UCommonButton* K2Node_ComponentBoundEvent_Button11, class UCommonButton* K2Node_ComponentBoundEvent_Button10, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue26, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue27, class UCommonButton* K2Node_ComponentBoundEvent_Button9, class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue6, bool CallFunc_IsValid_ReturnValue1, class UUserWidget* CallFunc_GetCachedWidget_ReturnValue2, class UHUDLayoutTool_C* K2Node_DynamicCast_AsHUDLayout_Tool, bool K2Node_DynamicCast_bSuccess1, class UFortAsyncAction_ShowConfirmation_NUI* CallFunc_ShowSimpleConfirmationDialog_NUI_ReturnValue, bool CallFunc_IsValid_ReturnValue2, class UCommonButton* K2Node_ComponentBoundEvent_Button8, enum class EFortDialogResult Temp_byte_Variable9, class FName Temp_name_Variable1, bool K2Node_SwitchEnum1_CmpSuccess, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate5, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate6, bool CallFunc_IsMobileGame_ReturnValue, enum class EFortDialogResult K2Node_CustomEvent_Result1, class FName K2Node_CustomEvent_ResultName1, const struct FSlateBrush& K2Node_MakeStruct_SlateBrush, class UFortAsyncAction_ShowConfirmation_NUI* CallFunc_ShowSimpleConfirmationDialog_NUI_ReturnValue1, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate7, bool CallFunc_IsValid_ReturnValue3, class UCommonButton* K2Node_ComponentBoundEvent_Button7, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue1, bool CallFunc_GetIsPlayerReportingFlowEnabled_ReturnValue, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate8, enum class ESlateVisibility K2Node_Select1_Default, class UFortAsyncAction_ShowConfirmation_NUI* CallFunc_ShowSimpleConfirmationDialog_NUI_ReturnValue2, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue2, class UReportPlayer_C* CallFunc_Create_ReturnValue2, bool CallFunc_IsValid_ReturnValue4, enum class EFortDialogResult Temp_byte_Variable10, class FName Temp_name_Variable2, bool K2Node_SwitchEnum2_CmpSuccess, class UCommonButton* K2Node_ComponentBoundEvent_Button6, class UCommonButton* K2Node_ComponentBoundEvent_Button5, class UCommonButton* K2Node_ComponentBoundEvent_Button4, class UCommonButton* K2Node_ComponentBoundEvent_Button3, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue2, enum class EFortDialogResult K2Node_CustomEvent_Result2, class FName K2Node_CustomEvent_ResultName2, bool CallFunc_ShowWebURL_ReturnValue, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate9, class UCommonButton* K2Node_ComponentBoundEvent_Button2, class UCommonButton* K2Node_ComponentBoundEvent_Button1, class UCommonButton* K2Node_ComponentBoundEvent_Button, bool CallFunc_IsTencentBuild_ReturnValue, const struct FGeometry& K2Node_Event_MyGeometry, float K2Node_Event_InDeltaTime, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue3, bool CallFunc_IsMobileGame_ReturnValue1, enum class ESlateVisibility K2Node_Select2_Default)
{
	...
	Parms.CallFunc_GetContext_ReturnValue9 = CallFunc_GetContext_ReturnValue9;
	Parms.Temp_bool_Variable1 = Temp_bool_Variable1;
	Parms.CallFunc_IsMatchmakingFlowActive_ReturnValue = CallFunc_IsMatchmakingFlowActive_ReturnValue;
	Parms.Temp_byte_Variable7 = Temp_byte_Variable7;
	Parms.CallFunc_Not_PreBool_ReturnValue = CallFunc_Not_PreBool_ReturnValue;
	...
	Parms.CallFunc_GetInputManager_ReturnValue4 = CallFunc_GetInputManager_ReturnValue4;
	...
	Parms.CallFunc_GetContext_ReturnValue25 = CallFunc_GetContext_ReturnValue25;
	...
	Parms.CallFunc_GetContext_ReturnValue26 = CallFunc_GetContext_ReturnValue26;
	Parms.CallFunc_GetContext_ReturnValue27 = CallFunc_GetContext_ReturnValue27;

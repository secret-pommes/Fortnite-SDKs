...
public:
	...
	uint8                                        bReverse : 1;                                      // Mask: 0x1, PropSize: 0x10x24(0x1)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_14E3[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_14E4[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]

...
public:
	...
	class UParticleSystemComponent*              JumpParticleSystem;                                // 0xC88(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)

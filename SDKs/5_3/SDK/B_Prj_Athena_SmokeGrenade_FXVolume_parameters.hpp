...
struct AB_Prj_Athena_SmokeGrenade_FXVolume_C_UserConstructionScript_Params
{
public:
	bool                                         CallFunc_IsDedicatedServer_ReturnValue;            // 0x0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_50E0[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
struct AB_Prj_Athena_SmokeGrenade_FXVolume_C_FadeSmokeTL__FinishedFunc_Params
{
public:
};
...
struct AB_Prj_Athena_SmokeGrenade_FXVolume_C_FadeSmokeTL__UpdateFunc_Params
{
public:
};
...
struct AB_Prj_Athena_SmokeGrenade_FXVolume_C_ReceiveBeginPlay_Params
{
public:
};
...
struct AB_Prj_Athena_SmokeGrenade_FXVolume_C_FadeIn_Params
{
public:
};
...
struct AB_Prj_Athena_SmokeGrenade_FXVolume_C_FadeOut_Params
{
public:
};
...
struct AB_Prj_Athena_SmokeGrenade_FXVolume_C_ExecuteUbergraph_B_Prj_Athena_SmokeGrenade_FXVolume_Params
{
public:
	...
	uint8                                        Pad_50E2[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_50E3[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        K2Node_Select_Default;                             // 0x14(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_GreaterEqual_FloatFloat_ReturnValue1;     // 0x18(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	float                                        K2Node_Select2_Default;                            // 0x50(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

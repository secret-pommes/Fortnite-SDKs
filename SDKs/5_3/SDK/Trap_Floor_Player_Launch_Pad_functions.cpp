...
{
	static auto Func = Class->GetFunction("Trap_Floor_Player_Launch_Pad_C", "UserConstructionScript");

	Params::ATrap_Floor_Player_Launch_Pad_C_UserConstructionScript_Params Parms;

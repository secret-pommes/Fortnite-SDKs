...
{
	static auto Func = Class->GetFunction("Frontend_Upgrades_Camera_C", "UserConstructionScript");

	Params::AFrontend_Upgrades_Camera_C_UserConstructionScript_Params Parms;
...
void AFrontend_Upgrades_Camera_C::ExecuteUbergraph_Frontend_Upgrades_Camera(int32 EntryPoint, class AFortTimeOfDayManager* CallFunc_GetTimeOfDayManagerFromContext_ReturnValue, TArray<class ATVPostProcessBP_C*>& CallFunc_GetAllActorsOfClass_OutActors, class ATVPostProcessBP_C* CallFunc_Array_Get_Item)
{

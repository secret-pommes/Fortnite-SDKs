...
public:
	...
	struct FVector                               CallFunc_GetSocketLocation_ReturnValue;            // 0x20(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                               CallFunc_GetSocketLocation_ReturnValue1;           // 0x40(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_5E6B[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FRotator                              CallFunc_Conv_VectorToRotator_ReturnValue;         // 0x9C(0xC)(IsPlainOldData, NoDestructor)

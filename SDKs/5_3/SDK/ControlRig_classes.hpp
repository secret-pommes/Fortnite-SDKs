...
{
public:
	uint8                                        Pad_6[0x14];                                       // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_8[0x40];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_9[0x8];                                        // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_C[0x8];                                        // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_D[0x6];                                        // Fixing Size After Last Property  [ Dumper-7 ]

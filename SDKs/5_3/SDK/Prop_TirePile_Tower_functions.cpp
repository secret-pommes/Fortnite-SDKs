...
{
	static auto Func = Class->GetFunction("Prop_TirePile_Tower_C", "UserConstructionScript");

	Params::AProp_TirePile_Tower_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("Prop_TirePile_Tower_C", "BndEvt__Jump_Collision_K2Node_ComponentBoundEvent_252_ComponentBeginOverlapSignature__DelegateSignature");

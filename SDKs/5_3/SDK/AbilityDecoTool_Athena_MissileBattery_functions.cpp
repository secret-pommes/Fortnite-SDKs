...
{
	static auto Func = Class->GetFunction("AbilityDecoTool_Athena_MissileBattery_C", "HideMeshAndPlacement");
...
{
	static auto Func = Class->GetFunction("AbilityDecoTool_Athena_MissileBattery_C", "UserConstructionScript");

	Params::AAbilityDecoTool_Athena_MissileBattery_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("AbilityDecoTool_Athena_MissileBattery_C", "HideFor");
...
{
	static auto Func = Class->GetFunction("AbilityDecoTool_Athena_MissileBattery_C", "BPOnSetDecoObjectPreview");
...
{
	static auto Func = Class->GetFunction("AbilityDecoTool_Athena_MissileBattery_C", "Show");

	Params::AAbilityDecoTool_Athena_MissileBattery_C_Show_Params Parms;
...
{
	static auto Func = Class->GetFunction("AbilityDecoTool_Athena_MissileBattery_C", "ReceiveBeginPlay");

	Params::AAbilityDecoTool_Athena_MissileBattery_C_ReceiveBeginPlay_Params Parms;
...
{
	static auto Func = Class->GetFunction("AbilityDecoTool_Athena_MissileBattery_C", "ExecuteUbergraph_AbilityDecoTool_Athena_MissileBattery");

...
public:
	...
	uint8                                        Pad_14AB[0xA7];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_14AC[0x1D];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_14AE[0xA4];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_14AF[0xC0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_14B2[0x40];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_14B5[0xF];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_14B6[0x26];                                    // Fixing Size Of Struct [ Dumper-7 ]

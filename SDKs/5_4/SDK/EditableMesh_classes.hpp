...
{
public:
	uint8                                        Pad_1602[0xD50];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<class UEditableMeshAdapter*>          Adapters;                                          // 0xD78(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	int32                                        TextureCoordinateCount;                            // 0xD88(0x4)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_1603[0xF8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	int32                                        PendingCompactCounter;                             // 0xE84(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                        SubdivisionCount;                                  // 0xE88(0x4)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_1604[0x1E4];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1606[0xA4];                                    // Fixing Size Of Struct [ Dumper-7 ]

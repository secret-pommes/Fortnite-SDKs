...
void UMainMenu_C::BindDelegates(UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate1, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate2, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate3, class UFortPartyContext* CallFunc_GetContext_ReturnValue, class UFortPartyContext* CallFunc_GetContext_ReturnValue1, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate4, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate5, class UFortPartyContext* CallFunc_GetContext_ReturnValue2, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate6, class UFortUITeamInfo* CallFunc_GetLocalPlayerTeam_ReturnValue, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate7, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate8, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate9, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue3, class UFortPartyContext* CallFunc_GetContext_ReturnValue4, class UFortPartyContext* CallFunc_GetContext_ReturnValue5, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate10, class UFortMatchmakingContext* CallFunc_GetContext_ReturnValue6, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate11, class UFortPartyContext* CallFunc_GetContext_ReturnValue7, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate12, class UCommonUIContext* CallFunc_GetContext_ReturnValue8, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate13, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate14, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate15, class UFortPartyContext* CallFunc_GetContext_ReturnValue9, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate16, class UFortHUDContext* CallFunc_GetContext_ReturnValue10, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate17, class UFortMatchmakingContext* CallFunc_GetContext_ReturnValue11)
{
...
void UMainMenu_C::InitializeMainMenu(class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue, bool Temp_bool_Variable, bool CallFunc_AllowLogout_ReturnValue, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable1, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue1, bool CallFunc_IsInZone_ReturnValue, enum class ESlateVisibility K2Node_Select_Default, int32 Temp_int_Array_Index_Variable, enum class ESlateVisibility Temp_byte_Variable2, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UAthenaChallengesTab_C* CallFunc_Create_ReturnValue, bool Temp_bool_Variable1, enum class ESlateVisibility Temp_byte_Variable3, bool CallFunc_IsInAthena_ReturnValue, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue1, bool CallFunc_IsMobileGame_ReturnValue, class UTeamSelectWidget_C* CallFunc_Create_ReturnValue1, bool CallFunc_IsErebus_ReturnValue, bool Temp_bool_Variable2, enum class ESlateVisibility K2Node_Select1_Default, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue2, TArray<class UIconTextButton_C*>& K2Node_MakeArray_Array, bool CallFunc_IsInZone_ReturnValue1, class UIconTextButton_C* CallFunc_Array_Get_Item, bool CallFunc_BooleanOR_ReturnValue, bool CallFunc_BooleanOR_ReturnValue1, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_BooleanOR_ReturnValue2, class UFortUIDataConfigurationContext* CallFunc_GetContext_ReturnValue3, bool CallFunc_ArePartyFeaturesEnabled_ReturnValue, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue2, int32 Temp_int_Loop_Counter_Variable, class UPrivacyWidget_C* CallFunc_Create_ReturnValue2, bool CallFunc_Less_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue3, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue4, class UShowFriendCodesSelection_C* CallFunc_Create_ReturnValue3, bool CallFunc_AllowQuit_ReturnValue, bool CallFunc_IsInZone_ReturnValue2, bool CallFunc_IsOutpostOwner_OutpostOwner, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, enum class ESlateVisibility Temp_byte_Variable4, enum class ESlateVisibility Temp_byte_Variable5, bool Temp_bool_Variable3, enum class ESlateVisibility K2Node_Select2_Default, enum class ESlateVisibility Temp_byte_Variable6, enum class ESlateVisibility Temp_byte_Variable7, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue5, bool CallFunc_IsInZone_ReturnValue3, enum class ESlateVisibility K2Node_Select3_Default, bool CallFunc_BooleanAND_ReturnValue1, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue4, class UMessageCenterWidget_C* CallFunc_Create_ReturnValue4, class UNews_C* CallFunc_Create_ReturnValue5, class UPermissionsRoot_C* CallFunc_Create_ReturnValue6, class ULegalInfo_C* CallFunc_Create_ReturnValue7, class UOptionsMenu_C* CallFunc_Create_ReturnValue8)
{
...
// class UCommonInputContext*         CallFunc_GetContext_ReturnValue10                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_Greater_IntInt_ReturnValue                              (ZeroConstructor, IsPlainOldData, NoDestructor)
...
// class UFortFrontEndContext*        CallFunc_GetContext_ReturnValue18                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UCommonUIContext*            CallFunc_GetContext_ReturnValue19                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// UDelegateProperty_                 K2Node_CreateDelegate_OutputDelegate3                            (ZeroConstructor, NoDestructor)
...
// class UFortHUDContext*             CallFunc_GetContext_ReturnValue21                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UFortRuntimeOptions*         CallFunc_GetRuntimeOptions_ReturnValue                           (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UFortGlobalUIContext*        CallFunc_GetContext_ReturnValue26                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

...
void UItemInfoHeaderWidget_C::OverrideHeaderAndDiscription(class FText Hearder, class FText Desciption, const struct FFortRarityItemData& CallFunc_BPGetRarityData_ReturnValue)
{

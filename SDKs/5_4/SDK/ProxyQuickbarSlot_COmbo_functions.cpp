...
void UProxyQuickbarSlot_Combo_C::SetSlotIndex(int32 NewIndex, class FText CallFunc_Conv_IntToText_ReturnValue)
{
...
void UProxyQuickbarSlot_Combo_C::SetSlotType(uint8 Value, uint8 CallFunc_GetValidValue_ReturnValue, enum class EComboSlotType Temp_byte_Variable, const struct FSlateColor& K2Node_Select_Default)
{
...
void UProxyQuickbarSlot_Combo_C::ExecuteUbergraph_ProxyQuickbarSlot_Combo(int32 EntryPoint, int32 K2Node_Event_PropertyIndex, float K2Node_Event_NewValue, int32 CallFunc_Round_ReturnValue, int32 CallFunc_Round_ReturnValue1, uint8 CallFunc_Conv_IntToByte_ReturnValue, bool K2Node_SwitchInteger_CmpSuccess)
{

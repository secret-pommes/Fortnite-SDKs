...
struct ABP_ProjectileTrajectory_AthenaRed_C_UserConstructionScript_Params
{
public:
};
...
public:
	...
	uint8                                        Pad_6303[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	int32                                        CallFunc_Add_IntInt_ReturnValue;                   // 0x10(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_6304[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]

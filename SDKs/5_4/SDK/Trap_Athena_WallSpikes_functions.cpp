...
{
	static auto Func = Class->GetFunction("Trap_Athena_WallSpikes_C", "UserConstructionScript");

	Params::ATrap_Athena_WallSpikes_C_UserConstructionScript_Params Parms;

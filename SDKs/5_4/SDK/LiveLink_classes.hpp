...
public:
	...
	uint8                                        Pad_13D9[0xE];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_13DA[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_13DC[0x58];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_13DD[0xA8];                                    // Fixing Size Of Struct [ Dumper-7 ]

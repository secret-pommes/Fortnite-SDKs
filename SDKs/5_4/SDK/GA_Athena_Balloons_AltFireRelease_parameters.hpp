...
public:
	...
	bool                                         CallFunc_IsFalling_ReturnValue;                    // 0x199(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        CallFunc_GetValidValue_ReturnValue;                // 0x19A(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_35D6[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	bool                                         CallFunc_GetGender_IsMale;                         // 0x1AB(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_GetGender_IsFemale;                       // 0x1AC(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};

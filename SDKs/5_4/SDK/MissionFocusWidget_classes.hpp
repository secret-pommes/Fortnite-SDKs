...
public:
	...
	struct FTimerHandle                          RefreshTimerHandle;                                // 0x248(0x8)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)

...
public:
	...
	void ExecuteUbergraph_Fort_Entry_Music_Controller_BP(int32 EntryPoint, bool Temp_bool_Variable, bool CallFunc_Not_PreBool_ReturnValue, bool Temp_bool_Variable1, bool CallFunc_Not_PreBool_ReturnValue1, enum class ESubGame K2Node_CustomEvent_SubGame, class USoundBase* K2Node_CustomEvent_New_Music, bool K2Node_SwitchEnum_CmpSuccess, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue, bool CallFunc_NotEqual_ObjectObject_ReturnValue, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate);
};

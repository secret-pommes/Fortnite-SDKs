...
{
	static auto Func = Class->GetFunction("GCL_Carmine_Jump_Dive_C", "UpdateLocationAndRotation");

	Params::AGCL_Carmine_Jump_Dive_C_UpdateLocationAndRotation_Params Parms;
...
{
	static auto Func = Class->GetFunction("GCL_Carmine_Jump_Dive_C", "OnLoopingStart");

	Params::AGCL_Carmine_Jump_Dive_C_OnLoopingStart_Params Parms;
...
{
	static auto Func = Class->GetFunction("GCL_Carmine_Jump_Dive_C", "OnRemoval");

	Params::AGCL_Carmine_Jump_Dive_C_OnRemoval_Params Parms;
	Parms.MyTarget = MyTarget;
	Parms.Parameters = Parameters;
	Parms.ParticleComponents = ParticleComponents;
	Parms.AudioComponents = AudioComponents;

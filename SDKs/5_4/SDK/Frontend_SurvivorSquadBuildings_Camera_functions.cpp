...
{
	static auto Func = Class->GetFunction("Frontend_SurvivorSquadBuildings_Camera_C", "UserConstructionScript");

	Params::AFrontend_SurvivorSquadBuildings_Camera_C_UserConstructionScript_Params Parms;

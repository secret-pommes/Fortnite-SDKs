...
void USpectatedPlayerSwitcher_C::FocusWidget(class UFortUINavigationManager* CallFunc_GetUINavigationManager_ReturnValue)
{
	static auto Func = Class->GetFunction("SpectatedPlayerSwitcher_C", "FocusWidget");

	Params::USpectatedPlayerSwitcher_C_FocusWidget_Params Parms;

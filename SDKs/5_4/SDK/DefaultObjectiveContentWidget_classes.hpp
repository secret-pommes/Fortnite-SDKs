...
public:
	...
	struct FTimerHandle                          RefreshTimerHandle;                                // 0x238(0x8)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	...
	void UpdateAutoRefreshTimer(bool ShouldAutoRefresh, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, bool CallFunc_K2_IsTimerActiveHandle_ReturnValue, const struct FTimerHandle& CallFunc_K2_SetTimerDelegate_ReturnValue);

...
{
public:
	struct FSlateFontInfo                        NewLocalVar_0;                                     // 0x0(0x58)(Edit, BlueprintVisible, HasGetValueTypeHash)
	struct FSlateFontInfo                        K2Node_MakeStruct_SlateFontInfo;                   // 0x58(0x58)(HasGetValueTypeHash)
	struct FSlateFontInfo                        K2Node_MakeStruct_SlateFontInfo1;                  // 0xB0(0x58)(HasGetValueTypeHash)
};
...
{
public:
	struct FSlateFontInfo                        Output;                                            // 0x0(0x58)(Parm, OutParm, HasGetValueTypeHash)
};
...
{
public:
	struct FSlateFontInfo                        FontIn;                                            // 0x0(0x58)(BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)
};

...
public:
	...
	uint8                                        Pad_2793[0x24];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        BitPad_233 : 7;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	uint8                                        Pad_27A1[0x2];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_27A2[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_27A5[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_27A7[0x1F];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_27A8[0xA0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<struct FProceduralFoliageInstance>    InstancesArray;                                    // 0xD0(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                        Pad_27A9[0x78];                                    // Fixing Size Of Struct [ Dumper-7 ]

...
public:
	...
	struct FFortAthenaLoadout                    CallFunc_GetLoadoutForPlayer_ReturnValue;          // 0x18(0xC0)()
	enum class ESubGame                          CallFunc_GetSubGame_ReturnValue;                   // 0xD8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_EqualEqual_ByteByte_ReturnValue;          // 0xD9(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_3606[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class FName                                  CallFunc_Conv_StringToName_ReturnValue1;           // 0xE8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FFortHomeBaseInfo                     CallFunc_GetHomeBaseInfoForPlayer_Result;          // 0xF0(0x40)()
	bool                                         CallFunc_SetBannerImage_Success;                   // 0x130(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
public:
	...
	uint8                                        Pad_3610[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]

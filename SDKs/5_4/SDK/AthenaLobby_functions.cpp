...
void UAthenaLobby_C::CloseEmotePicker(class APlayerController* CallFunc_GetPlayerController_ReturnValue, class AFortPlayerControllerFrontEnd* K2Node_DynamicCast_AsFort_Player_Controller_Front_End, bool K2Node_DynamicCast_bSuccess, bool CallFunc_IsVisible_ReturnValue)
{
...
{
	static auto Func = Class->GetFunction("AthenaLobby_C", "BndEvt__AthenaToastWidget_K2Node_ComponentBoundEvent_1_OnFinishedToast__DelegateSignature");

	Params::UAthenaLobby_C_BndEvt__AthenaToastWidget_K2Node_ComponentBoundEvent_1_OnFinishedToast__DelegateSignature_Params Parms;

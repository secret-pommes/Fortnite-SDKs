...
void UAthenaChallengesTab_C::OnCursorModeChanged(bool IsEnabled, class UCommonUIContext* CallFunc_GetContext_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, class UCommonInputManager* CallFunc_GetInputManager_ReturnValue, class UCommonUIContext* CallFunc_GetContext_ReturnValue1, class UCommonInputManager* CallFunc_GetInputManager_ReturnValue1, bool CallFunc_IsPanelOnStack_ReturnValue, bool CallFunc_BooleanAND_ReturnValue)
{
...
{
	static auto Func = Class->GetFunction("AthenaChallengesTab_C", "BndEvt__BackgroundButton_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature");

	Params::UAthenaChallengesTab_C_BndEvt__BackgroundButton_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature_Params Parms;

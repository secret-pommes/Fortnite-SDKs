...
public:
	...
	struct FFortGameplayCueParticleInfo          LandParticle;                                      // 0x8A0(0x68)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FFortBurstEffectData                  LandBurst;                                         // 0x908(0x100)(Edit, BlueprintVisible, DisableEditOnInstance)

...
struct AGCNL_Cube_Area_C_UserConstructionScript_Params
{
public:
};
...
public:
	...
	uint8                                        Pad_3779[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FVector                               K2Node_CustomEvent_Location;                       // 0x214(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                               K2Node_CustomEvent_Velocity;                       // 0x220(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)

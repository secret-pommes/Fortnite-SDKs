...
public:
	...
	class UClass*                                GE_AIBaseMeleeFrustration_Build;                   // 0x948(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

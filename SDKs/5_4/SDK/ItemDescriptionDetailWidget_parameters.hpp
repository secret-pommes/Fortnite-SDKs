...
public:
	...
	uint8                                        Pad_4374[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	enum class ESlateVisibility                  K2Node_Select1_Default;                            // 0x99(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

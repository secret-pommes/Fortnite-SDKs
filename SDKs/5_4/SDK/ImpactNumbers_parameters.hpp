...
public:
	...
	uint8                                        Pad_41D5[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	struct FFortDamageNumberInfo                 NewDamageHitInfoStruct;                            // 0x0(0x68)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
	uint8                                        Pad_41E3[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_41E4[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_41EC[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]

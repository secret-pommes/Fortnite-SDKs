...
public:
	...
	uint8                                        Pad_4679[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FAnimatingMaterialPair                K2Node_MakeStruct_AnimatingMaterialPair;           // 0x8(0x10)(IsPlainOldData, NoDestructor)

...
void UDefaultObjectiveContentWidget_C::UpdateAutoRefreshTimer(bool ShouldAutoRefresh, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, bool CallFunc_K2_IsTimerActiveHandle_ReturnValue, const struct FTimerHandle& CallFunc_K2_SetTimerDelegate_ReturnValue)
{
	static auto Func = Class->GetFunction("DefaultObjectiveContentWidget_C", "UpdateAutoRefreshTimer");

	Params::UDefaultObjectiveContentWidget_C_UpdateAutoRefreshTimer_Params Parms;

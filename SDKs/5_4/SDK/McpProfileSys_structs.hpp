...
public:
	...
	uint8                                        Pad_14B9[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_14BB[0x38];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_14BC[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_14BE[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};

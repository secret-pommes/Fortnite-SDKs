...
public:
	...
	float                                        TriggerDuration;                                   // 0x908(0x4)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_597E[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FName                                  RiftItemHolster;                                   // 0x910(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

...
{
	static auto Func = Class->GetFunction("DA_RegenPack_C", "IsOnGround");
...
{
	static auto Func = Class->GetFunction("DA_RegenPack_C", "RaiseUsageError");
...
{
	static auto Func = Class->GetFunction("DA_RegenPack_C", "UserConstructionScript");

	Params::ADA_RegenPack_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("DA_RegenPack_C", "MinHeldTimeCheck");

	Params::ADA_RegenPack_C_MinHeldTimeCheck_Params Parms;
...
{
	static auto Func = Class->GetFunction("DA_RegenPack_C", "BPPressTrigger");
...
{
	static auto Func = Class->GetFunction("DA_RegenPack_C", "BPReleaseTrigger");
...
{
	static auto Func = Class->GetFunction("DA_RegenPack_C", "ExecuteUbergraph_DA_RegenPack");

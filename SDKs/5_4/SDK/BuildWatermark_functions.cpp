...
void UBuildWatermark_C::SetTextCollapseIfDefault(class UTextBlock* Text_Widget, class FText InputText, class FText DefaultText, bool CallFunc_EqualEqual_TextText_ReturnValue)
{

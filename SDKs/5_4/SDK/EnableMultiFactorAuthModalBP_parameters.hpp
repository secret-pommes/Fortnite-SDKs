...
public:
	...
	uint8                                        Pad_56A4[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_56A6[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	enum class ESocialImportPanelType            K2Node_Event_NewType;                              // 0x48(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_56A8[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        CallFunc_GetEndTime_ReturnValue;                   // 0x4C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FText                                  K2Node_Event_NewButtonText;                        // 0x58(0x18)(ConstParm)
	class FText                                  K2Node_Event_UniquePlayerURLText;                  // 0x70(0x18)(ConstParm)
	class UIconTextButton_C*                     K2Node_DynamicCast_AsIcon_Text_Button;             // 0x88(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                         K2Node_Event_bIsConsole;                           // 0xA0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};

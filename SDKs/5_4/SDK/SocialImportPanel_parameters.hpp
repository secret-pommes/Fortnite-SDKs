...
public:
	...
	uint8                                        Pad_4684[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class FText                                  Temp_text_Variable4;                               // 0xA0(0x18)()
	...
	class FText                                  Temp_text_Variable6;                               // 0xD8(0x18)()
	class FText                                  Temp_text_Variable7;                               // 0xF0(0x18)()
	class FText                                  Temp_text_Variable8;                               // 0x108(0x18)()
	...
	struct FSlateBrush                           Temp_struct_Variable1;                             // 0x1F8(0x88)()
	struct FSlateBrush                           Temp_struct_Variable2;                             // 0x280(0x88)()
	struct FSlateBrush                           Temp_struct_Variable3;                             // 0x308(0x88)()
	...
	struct FSlateBrush                           CallFunc_MakeBrushFromTexture_ReturnValue1;        // 0x470(0x88)()
	struct FSlateBrush                           K2Node_Select3_Default;                            // 0x4F8(0x88)()

...
{
public:
	uint8                                        Pad_1253[0x38];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1254[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1255[0x20];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1257[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	struct FDateTime                             LastCheckTimestamp;                                // 0x50(0x8)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	uint8                                        Pad_125A[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]

...
{
	static auto Func = Class->GetFunction("SimpleSquadSlotButton_C", "BP_OnHovered");

	Params::USimpleSquadSlotButton_C_BP_OnHovered_Params Parms;
...
void USimpleSquadSlotButton_C::ExecuteUbergraph_SimpleSquadSlotButton(int32 EntryPoint, enum class ESlateVisibility Temp_byte_Variable, class UHomeBaseContext* CallFunc_GetContext_ReturnValue, class FName CallFunc_GetActiveCombatSquadId_ReturnValue, enum class EFortItemCardSize Temp_byte_Variable1, class UClass* Temp_class_Variable, class UClass* Temp_class_Variable1, class UClass* Temp_class_Variable2, class UClass* Temp_class_Variable3, class UClass* Temp_class_Variable4, class UClass* Temp_class_Variable5, class UClass* Temp_class_Variable6, bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable2, enum class ESlateVisibility Temp_byte_Variable3, class UCommonInputContext* CallFunc_GetContext_ReturnValue1, bool K2Node_Event_IsDesignTime, enum class ECommonInputType CallFunc_GetCurrentInputType_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue, enum class ESlateVisibility Temp_byte_Variable4, class FName CallFunc_GetIdOfSquadSlotToManageBP_OutSquadId, int32 CallFunc_GetIdOfSquadSlotToManageBP_OutSquadSlotIndex, bool CallFunc_EqualEqual_NameName_ReturnValue, class UClass* K2Node_Select_Default, bool K2Node_ComponentBoundEvent_bIsOpen, bool Temp_bool_Variable1, enum class ESlateVisibility K2Node_Select1_Default, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue2, bool CallFunc_IsInZone_ReturnValue, enum class ESlateVisibility K2Node_Select2_Default)
{

...
public:
	...
	void ExecuteUbergraph_VehicleInfoIndicator(int32 EntryPoint, bool CallFunc_IsValid_ReturnValue, float CallFunc_GetMaxHealth_ReturnValue, bool CallFunc_Greater_FloatFloat_ReturnValue, float CallFunc_GetHealth_ReturnValue);
};

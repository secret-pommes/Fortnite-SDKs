...
{
	static auto Func = Class->GetFunction("GA_Athena_Medkit_C", "K2_CanActivateAbility");
...
{
	static auto Func = Class->GetFunction("GA_Athena_Medkit_C", "Completed_4F161F934DDA0C407BD9A48EEEE7DDCE");
...
{
	static auto Func = Class->GetFunction("GA_Athena_Medkit_C", "Cancelled_4F161F934DDA0C407BD9A48EEEE7DDCE");
...
{
	static auto Func = Class->GetFunction("GA_Athena_Medkit_C", "Triggered_4F161F934DDA0C407BD9A48EEEE7DDCE");
...
{
	static auto Func = Class->GetFunction("GA_Athena_Medkit_C", "K2_ActivateAbility");

	Params::UGA_Athena_Medkit_C_K2_ActivateAbility_Params Parms;
...
{
	static auto Func = Class->GetFunction("GA_Athena_Medkit_C", "K2_OnEndAbility");
...
{
	static auto Func = Class->GetFunction("GA_Athena_Medkit_C", "ExecuteUbergraph_GA_Athena_Medkit");

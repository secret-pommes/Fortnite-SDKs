...
public:
	...
	struct FLinearColor                          K2Node_MakeStruct_LinearColor;                     // 0x24(0x10)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct ASunDirectionandColorSet_C_ReceiveBeginPlay_Params
{
public:
};

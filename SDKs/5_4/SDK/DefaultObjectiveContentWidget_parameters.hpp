...
struct UDefaultObjectiveContentWidget_C_UpdateAutoRefreshTimer_Params
{
public:
	bool                                         ShouldAutoRefresh;                                 // 0x0(0x1)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
...
public:
	...
	class FText                                  CallFunc_GetEmptyText_ReturnValue;                 // 0x68(0x18)()
	class UMissionRichText_C*                    CallFunc_GetRichTextBlock_MissionRichTextBlock;    // 0x80(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UFortMissionTimerComponent*            CallFunc_GetTimerComponent_ReturnValue;            // 0x88(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FText                                  CallFunc_GetTimeText_ReturnValue;                  // 0x98(0x18)()
	bool                                         CallFunc_IsTimerVisible_ReturnValue;               // 0xB0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	float                                        CallFunc_GetMissionTimerTimeRemaining_ReturnValue; // 0xF8(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FText                                  CallFunc_GetObjectiveDisplayString_ReturnValue;    // 0x138(0x18)()

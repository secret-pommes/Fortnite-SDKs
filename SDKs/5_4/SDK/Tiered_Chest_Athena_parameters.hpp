...
public:
	...
	struct FVector                               CallFunc_K2_GetActorLocation_ReturnValue;          // 0x44(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FRotator                              CallFunc_K2_GetActorRotation_ReturnValue;          // 0x50(0xC)(IsPlainOldData, NoDestructor)
	...
	struct FRotator                              CallFunc_MakeRotator_ReturnValue;                  // 0x6C(0xC)(IsPlainOldData, NoDestructor)
	...
	struct FVector                               CallFunc_Conv_LinearColorToVector_ReturnValue;     // 0x100(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                               CallFunc_K2_GetActorLocation_ReturnValue1;         // 0x154(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                               CallFunc_VLerp_ReturnValue;                        // 0x180(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                               K2Node_Event_Momentum;                             // 0x1B8(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_317D[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FHitResult                            K2Node_Event_HitInfo;                              // 0x1C8(0x88)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)

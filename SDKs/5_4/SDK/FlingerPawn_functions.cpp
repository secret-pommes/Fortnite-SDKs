...
void AFlingerPawn_C::SetScalarParameterOnAllCharacterMIDs(class FName Parameter_Name, float Scalar_Value, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue1)
{
	static auto Func = Class->GetFunction("FlingerPawn_C", "SetScalarParameterOnAllCharacterMIDs");

	Params::AFlingerPawn_C_SetScalarParameterOnAllCharacterMIDs_Params Parms;
...
{
	static auto Func = Class->GetFunction("FlingerPawn_C", "RestorePreviousMaterialDelayCompleted");

	Params::AFlingerPawn_C_RestorePreviousMaterialDelayCompleted_Params Parms;
...
{
	static auto Func = Class->GetFunction("FlingerPawn_C", "RestorePreviousMaterialDelay");

	Params::AFlingerPawn_C_RestorePreviousMaterialDelay_Params Parms;

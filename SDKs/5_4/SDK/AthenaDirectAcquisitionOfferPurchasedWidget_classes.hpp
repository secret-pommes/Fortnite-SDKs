...
public:
	...
	void ExecuteUbergraph_AthenaDirectAcquisitionOfferPurchasedWidget(int32 EntryPoint, class UCommonUIContext* CallFunc_GetContext_ReturnValue, bool Temp_bool_Variable, class UCommonInputManager* CallFunc_GetInputManager_ReturnValue, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable1, const struct FDataTableRowHandle& K2Node_MakeStruct_DataTableRowHandle, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue1, class UFortDirectAcquisitionOfferInfo* CallFunc_GetOfferInfo_ReturnValue, bool CallFunc_IsUnique_ReturnValue, enum class EFrontEndCamera Temp_byte_Variable2, class UFortDirectAcquisitionOfferInfo* CallFunc_GetOfferInfo_ReturnValue1, bool CallFunc_IsPanelOnStack_ReturnValue, const struct FCatalogOffer& CallFunc_GetOffer_ReturnValue, enum class EFrontEndCamera Temp_byte_Variable3, class UCommonButton* K2Node_ComponentBoundEvent_Button, bool CallFunc_HandleBack_Passthrough, bool Temp_bool_Variable1, bool CallFunc_IsMobileGame_ReturnValue, enum class EFrontEndCamera K2Node_Select_Default, bool CallFunc_IsMobileGame_ReturnValue1, enum class ESlateVisibility K2Node_Select1_Default, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue2);
};

...
public:
	...
	uint8                                        Pad_125B[0x5];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_125F[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FDateTime                             LastCheckTimestamp;                                // 0x58(0x8)(Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_1260[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};

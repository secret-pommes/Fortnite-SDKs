...
public:
	...
	class UParticleSystemComponent*              JumpParticleEffect;                                // 0xC90(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
